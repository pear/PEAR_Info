...
class PEAR_Info_TestCase_DefaultConfig extends PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $sysconfdir       = dirname(__FILE__) . $ds . 'sysconf_dir';
        ...
        if (!file_exists($conf_file)) {
            ...
            $config->set('php_dir', dirname(__FILE__) . $ds . 'pear_dir');
    ...
    public function testConfigFilesExistInSysConfDir()
    {
        ...
        $this->assertNotNull($pearInfo->reg,
            'System PEAR configuration files does not exist');
    }
}

// Call PEAR_Info_TestCase_DefaultConfig::main()
